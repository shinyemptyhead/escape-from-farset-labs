...
This is an alpha build intended only for playtesting. 
...
If you're completely new to text adventures, check out the postcard or the introductory booklet for an overview. There is also some basic help available within the game itself."
...
The introduction is a text variable. The introduction is "It's been another productive day at Farset Labs, a perfect little hackerspace tucked away in the corner of Belfast. But you're done for the day and it's time to go home.
...
Or at least that's the plan. Unfortunately it all goes sideways as you approach the exit from Weaver's Park and try to apply the brakes on your bike to slow down. With a sudden 'snap!' one of the levers gives way, and you have a very exciting few seconds as you turn the bike to try to avoid sailing out into the road. Luckily you manage to avoid disaster, and you walk back to the Labs with your bicycle.
...
When The Opening begins, say the introduction.
...
Instead of going south in the Lobby:
	...
	otherwise if the player is not carrying the backpack:
	...
	otherwise:
		end the story saying "Having repaired your bike and tied up all the loose ends, you're finally able to head out into the crisp Belfast evening and onto the road home. Congratulations, you have...
...
The player is carrying a backpack. The description of the backpack is "It's battered, but you don't go anywhere without it."
...
The BSides Belfast poster is in the Event Area. "A colourful orange and red poster catches your eye." The poster is fixed in place. The description is "A poster for BSides Belfast 2023, a local information security conference. It shows a magnificent drawing of a phoenix roosting on the Harland and Woolf cranes that form part of the BSides Belfast logo. It doesn't help you with your current problems, but it does cheer you up to remember there is more to life than this." Understand "posters" as the poster. Understand "walls" as the poster.
...
SECTION 6 - Help and other text dumps
